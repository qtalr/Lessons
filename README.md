...
| Advanced Tables        | Explore how to enhance dataset summaries using the janitor package and present them effectively with the kableExtra package's advanced formatting options.                                                                                                                                | Inference                |
